    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div className="flex items-center gap-4">
          <Link href="/admin/users" className="p-2 hover:bg-[#1a3d32] rounded-lg transition-colors shrink-0">
        ...
        <Link
          ...
          className="flex items-center gap-2 bg-[#00ff7f] text-black px-4 md:px-6 py-2.5 md:py-3 rounded-xl hover:bg-[#00ff7f]/90 transition-all font-medium self-start sm:self-auto text-sm md:text-base shrink-0"
        >
